...
class Atri:
	def __init__(self, state: Any):
		...
		self.Nav_bar = state["Nav_bar"]
		self.Nav_flex = state["Nav_flex"]
		self.Div3 = state["Div3"]
		self.Flex2 = state["Flex2"]
		self.Div2 = state["Div2"]
		self.Flex3 = state["Flex3"]
		self.dotflex = state["dotflex"]
		self.Introduction = state["Introduction"]
		...
		self.DescriptionCard = state["DescriptionCard"]
		...
		self.ProductBar = state["ProductBar"]
		self.Flex84 = state["Flex84"]
		self.Div154 = state["Div154"]
		self.Div155 = state["Div155"]
		self.ProductImages1 = state["ProductImages1"]
		...
		self.university_card = state["university_card"]
		...
		self.Work_Experience = state["Work_Experience"]
		...
		self.leftcolumn = state["leftcolumn"]
		self.Div250 = state["Div250"]
		self.faqCard1 = state["faqCard1"]
		...
		self.view_projects = state["view_projects"]
		self.projects = state["projects"]
	...
	@property
	def Nav_bar(self):
		self._getter_access_tracker["Nav_bar"] = {}
		return self._Nav_bar
	@Nav_bar.setter
	def Nav_bar(self, new_state):
		self._setter_access_tracker["Nav_bar"] = {}
		global default_state
		self._Nav_bar = Div(new_state, default_state["Nav_bar"])

	@property
	def Nav_flex(self):
		self._getter_access_tracker["Nav_flex"] = {}
		return self._Nav_flex
	@Nav_flex.setter
	def Nav_flex(self, new_state):
		self._setter_access_tracker["Nav_flex"] = {}
		global default_state
		self._Nav_flex = Flex(new_state, default_state["Nav_flex"])
	...
	@property
	def dotflex(self):
		self._getter_access_tracker["dotflex"] = {}
		return self._dotflex
	@dotflex.setter
	def dotflex(self, new_state):
		self._setter_access_tracker["dotflex"] = {}
		global default_state
		self._dotflex = Flex(new_state, default_state["dotflex"])

	@property
	def Introduction(self):
		self._getter_access_tracker["Introduction"] = {}
		return self._Introduction
	@Introduction.setter
	def Introduction(self, new_state):
		self._setter_access_tracker["Introduction"] = {}
		global default_state
		self._Introduction = Div(new_state, default_state["Introduction"])
	...
	def Trusted_By(self, new_state):
		...
		global default_state
		self._Trusted_By = Div(new_state, default_state["Trusted_By"])
	...
	def Services(self, new_state):
		...
		global default_state
		self._Services = Div(new_state, default_state["Services"])
	...
	@property
	def Tagdiv(self):
		self._getter_access_tracker["Tagdiv"] = {}
		return self._Tagdiv
	@Tagdiv.setter
	def Tagdiv(self, new_state):
		self._setter_access_tracker["Tagdiv"] = {}
		global default_state
		self._Tagdiv = Div(new_state, default_state["Tagdiv"])
	...
	def Card1(self, new_state):
		...
		global default_state
		self._Card1 = Div(new_state, default_state["Card1"])
	...
	@property
	def DescriptionCard(self):
		self._getter_access_tracker["DescriptionCard"] = {}
		return self._DescriptionCard
	@DescriptionCard.setter
	def DescriptionCard(self, new_state):
		self._setter_access_tracker["DescriptionCard"] = {}
		global default_state
		self._DescriptionCard = Div(new_state, default_state["DescriptionCard"])
	...
	def Projects(self, new_state):
		...
		global default_state
		self._Projects = Div(new_state, default_state["Projects"])
	...
	@property
	def Projectmanager_white(self):
		self._getter_access_tracker["Projectmanager_white"] = {}
		return self._Projectmanager_white
	@Projectmanager_white.setter
	def Projectmanager_white(self, new_state):
		self._setter_access_tracker["Projectmanager_white"] = {}
		global default_state
		self._Projectmanager_white = Div(new_state, default_state["Projectmanager_white"])
	...
	@property
	def Project1(self):
		self._getter_access_tracker["Project1"] = {}
		return self._Project1
	@Project1.setter
	def Project1(self, new_state):
		self._setter_access_tracker["Project1"] = {}
		global default_state
		self._Project1 = Div(new_state, default_state["Project1"])
	...
	@property
	def Projectmanager_black(self):
		self._getter_access_tracker["Projectmanager_black"] = {}
		return self._Projectmanager_black
	@Projectmanager_black.setter
	def Projectmanager_black(self, new_state):
		self._setter_access_tracker["Projectmanager_black"] = {}
		global default_state
		self._Projectmanager_black = Div(new_state, default_state["Projectmanager_black"])
	...
	def Blogs(self, new_state):
		...
		global default_state
		self._Blogs = Div(new_state, default_state["Blogs"])
	...
	@property
	def Bloagsdiv(self):
		self._getter_access_tracker["Bloagsdiv"] = {}
		return self._Bloagsdiv
	@Bloagsdiv.setter
	def Bloagsdiv(self, new_state):
		self._setter_access_tracker["Bloagsdiv"] = {}
		global default_state
		self._Bloagsdiv = Div(new_state, default_state["Bloagsdiv"])
	...
	@property
	def blog_card1(self):
		self._getter_access_tracker["blog_card1"] = {}
		return self._blog_card1
	@blog_card1.setter
	def blog_card1(self, new_state):
		self._setter_access_tracker["blog_card1"] = {}
		global default_state
		self._blog_card1 = Div(new_state, default_state["blog_card1"])
	...
	@property
	def ProductBar(self):
		self._getter_access_tracker["ProductBar"] = {}
		return self._ProductBar
	@ProductBar.setter
	def ProductBar(self, new_state):
		self._setter_access_tracker["ProductBar"] = {}
		global default_state
		self._ProductBar = Div(new_state, default_state["ProductBar"])
	...
	@property
	def ProductImages1(self):
		self._getter_access_tracker["ProductImages1"] = {}
		return self._ProductImages1
	@ProductImages1.setter
	def ProductImages1(self, new_state):
		self._setter_access_tracker["ProductImages1"] = {}
		global default_state
		self._ProductImages1 = Div(new_state, default_state["ProductImages1"])
	...
	@property
	def Experience(self):
		self._getter_access_tracker["Experience"] = {}
		return self._Experience
	@Experience.setter
	def Experience(self, new_state):
		self._setter_access_tracker["Experience"] = {}
		global default_state
		self._Experience = Div(new_state, default_state["Experience"])
	...
	def Education(self, new_state):
		...
		global default_state
		self._Education = Div(new_state, default_state["Education"])
	...
	@property
	def university_card(self):
		self._getter_access_tracker["university_card"] = {}
		return self._university_card
	@university_card.setter
	def university_card(self, new_state):
		self._setter_access_tracker["university_card"] = {}
		global default_state
		self._university_card = Div(new_state, default_state["university_card"])
	...
	def Work_Experience(self):
		self._getter_access_tracker["Work_Experience"] = {}
		return self._Work_Experience
	@Work_Experience.setter
	def Work_Experience(self, new_state):
		self._setter_access_tracker["Work_Experience"] = {}
		global default_state
		self._Work_Experience = Div(new_state, default_state["Work_Experience"])
	...
	def Testimonials(self, new_state):
		...
		global default_state
		self._Testimonials = Div(new_state, default_state["Testimonials"])
	...
	@property
	def FAQs(self):
		self._getter_access_tracker["FAQs"] = {}
		return self._FAQs
	@FAQs.setter
	def FAQs(self, new_state):
		self._setter_access_tracker["FAQs"] = {}
		global default_state
		self._FAQs = Div(new_state, default_state["FAQs"])
	...
	@property
	def leftcolumn(self):
		self._getter_access_tracker["leftcolumn"] = {}
		return self._leftcolumn
	@leftcolumn.setter
	def leftcolumn(self, new_state):
		self._setter_access_tracker["leftcolumn"] = {}
		global default_state
		self._leftcolumn = Div(new_state, default_state["leftcolumn"])
	...
	@property
	def faqCard1(self):
		self._getter_access_tracker["faqCard1"] = {}
		return self._faqCard1
	@faqCard1.setter
	def faqCard1(self, new_state):
		self._setter_access_tracker["faqCard1"] = {}
		global default_state
		self._faqCard1 = Div(new_state, default_state["faqCard1"])
	...
	@property
	def call_me(self):
		self._getter_access_tracker["call_me"] = {}
		return self._call_me
	@call_me.setter
	def call_me(self, new_state):
		self._setter_access_tracker["call_me"] = {}
		global default_state
		self._call_me = Div(new_state, default_state["call_me"])
	...
	def about(self, new_state):
		...
		global default_state
		self._about = Div(new_state, default_state["about"])
	...
	@property
	def DotImage(self):
		self._getter_access_tracker["DotImage"] = {}
		return self._DotImage
	@DotImage.setter
	def DotImage(self, new_state):
		self._setter_access_tracker["DotImage"] = {}
		global default_state
		self._DotImage = Image(new_state, default_state["DotImage"])
	...
	@property
	def Book_a_cal(self):
		self._getter_access_tracker["Book_a_cal"] = {}
		return self._Book_a_cal
	@Book_a_cal.setter
	def Book_a_cal(self, new_state):
		self._setter_access_tracker["Book_a_cal"] = {}
		global default_state
		self._Book_a_cal = Button(new_state, default_state["Book_a_cal"])
	...
	@property
	def My_image(self):
		self._getter_access_tracker["My_image"] = {}
		return self._My_image
	@My_image.setter
	def My_image(self, new_state):
		self._setter_access_tracker["My_image"] = {}
		global default_state
		self._My_image = Image(new_state, default_state["My_image"])
	...
	def view_projects(self):
		self._getter_access_tracker["view_projects"] = {}
		return self._view_projects
	@view_projects.setter
	def view_projects(self, new_state):
		self._setter_access_tracker["view_projects"] = {}
		global default_state
		self._view_projects = Button(new_state, default_state["view_projects"])
	...
	def _to_json_fields(self):
		return {
			...
			"Nav_flex": self._Nav_flex,
			"Div3": self._Div3,
			"Flex2": self._Flex2,
			"Div2": self._Div2,
			"Flex3": self._Flex3,
			"dotflex": self._dotflex,
			...
			"Card1": self._Card1,
			"Image": self._Image,
			"DescriptionCard": self._DescriptionCard,
			"Div21": self._Div21,
			"Flex13": self._Flex13,
			"Flex16": self._Flex16,
			"Flex17": self._Flex17,
			...
			"Flex60": self._Flex60,
			"Div79": self._Div79,
			"Projectmanager_white": self._Projectmanager_white,
			"Div84": self._Div84,
			"Flex61": self._Flex61,
			"Div85": self._Div85,
			"Flex62": self._Flex62,
			...
			"Flex74": self._Flex74,
			"Div132": self._Div132,
			"Projectmanager_black": self._Projectmanager_black,
			"Flex75": self._Flex75,
			"Blogs": self._Blogs,
			"Flex76": self._Flex76,
			"Bloagsdiv": self._Bloagsdiv,
			"Div139": self._Div139,
			"Div138": self._Div138,
			"Flex77": self._Flex77,
			"blog_card1": self._blog_card1,
			"Flex78": self._Flex78,
			"Div142": self._Div142,
			"Div157": self._Div157,
			"Div156": self._Div156,
			...
			"Div162": self._Div162,
			"Flex88": self._Flex88,
			"ProductBar": self._ProductBar,
			"Flex84": self._Flex84,
			"Div154": self._Div154,
			"Div155": self._Div155,
			"ProductImages1": self._ProductImages1,
			"Div165": self._Div165,
			"Flex89": self._Flex89,
			"Div177": self._Div177,
			"Flex96": self._Flex96,
			...
			"Div190": self._Div190,
			"Div191": self._Div191,
			"university_card": self._university_card,
			"Div189": self._Div189,
			...
			"Work_Experience": self._Work_Experience,
			"Div214": self._Div214,
			"Div210": self._Div210,
			...
			"leftcolumn": self._leftcolumn,
			"Div250": self._Div250,
			"faqCard1": self._faqCard1,
			...
			"Book_a_cal": self._Book_a_cal,
			"TextBox10": self._TextBox10,
			"Image4": self._Image4,
			"My_image": self._My_image,
			...
			"view_projects": self._view_projects,
			"projects": self._projects,
